    ...
    <section className="bg-neutral-50 py-16">
      <div className="max-w-6xl mx-auto px-4">
        <div className="bg-white rounded-lg shadow-sm p-8">
          <h2 className="text-2xl font-bold text-black mb-4">Latest from the Blog</h2>
          ...
          <Link
            ...
            className="inline-flex items-center px-4 py-2 bg-black text-white font-medium rounded-lg hover:bg-neutral-900 transition-colors duration-200"
          >
            Read More →
          </Link>
        </div>
