...
export const metadata = {
  title: "LaunchOps — Technical Overview",
  description:
    "LaunchOps is an AI Development Platform for software developers. Deterministic-first with LLM orchestration, policy, receipts, and audit. Deploy in your K8s or cloud.",
};
    ...
    <main className="min-h-screen bg-white text-gray-900">
      ...
      <header className="sticky top-0 z-40 bg-white/80 backdrop-blur border-b">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 h-14 flex items-center justify-between">
          <div className="font-semibold">LaunchOps</div>
      ...
      <section className="bg-gradient-to-r from-black to-neutral-900 text-white">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-16 md:py-20">
          <div className="max-w-3xl">
            ...
            <h1 className="text-4xl md:text-5xl font-semibold leading-tight">LaunchOps — the AI Development Platform for building enterprise AI apps</h1>
            <p className="mt-4 text-lg text-white/90">
              Deterministic tools and rules do the work; LLMs orchestrate, summarize, and explain. LaunchOps streams structured outputs (ChatBlocks) with policy, receipts, and audit built in. Deploy in your Kubernetes cluster or cloud.
            </p>
      ...
      <section id="faq">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-14">
          ...
          <div className="mt-6 grid gap-6">
            <div className="rounded-2xl border p-6">
              <div className="font-medium">How is LaunchOps different from a generic “chatbot”?</div>
