...
export default function ComfyUIRequestPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      const res = await fetch('/api/contact', {
        ...
        body: JSON.stringify({ name, email, product: 'comfyui' }),
      });
      ...
      <div className="pt-24 pb-16">
        <div className="mx-auto max-w-2xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-sm text-foreground/50 mb-8">
            ...
            <Link href="/apps/comfyui" className="hover:text-accent transition-colors">
              ComfyUI
            </Link>
            <span className="mx-2">&middot;</span>
          ...
          <h1 className="text-3xl md:text-4xl font-bold text-foreground mb-4">
            Request a ComfyUI instance
          </h1>
          <p className="text-foreground/70 mb-8">
            Tell us your name and email. We&apos;ll provision a dedicated ComfyUI
            instance on your own subdomain and send you login credentials.
          </p>
