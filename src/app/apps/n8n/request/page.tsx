...
export default function N8nRequestPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      const res = await fetch('/api/contact', {
        ...
        body: JSON.stringify({ name, email, product: 'n8n' }),
      });
      ...
      <div className="pt-24 pb-16">
        <div className="mx-auto max-w-2xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-sm text-foreground/50 mb-8">
            ...
            <Link href="/apps/n8n" className="hover:text-accent transition-colors">
              n8n
            </Link>
            <span className="mx-2">&middot;</span>
          ...
          <h1 className="text-3xl md:text-4xl font-bold text-foreground mb-4">
            Request an n8n instance
          </h1>
          <p className="text-foreground/70 mb-8">
            Tell us your name and email. We&apos;ll provision a dedicated n8n instance
            on your own subdomain and send you login details.
          </p>
