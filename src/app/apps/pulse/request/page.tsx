...
export default function PulseRequestPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      const res = await fetch('/api/contact', {
        ...
        body: JSON.stringify({ name, email, product: 'pulse' }),
      });
      ...
      <div className="pt-24 pb-16">
        <div className="mx-auto max-w-2xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-sm text-foreground/50 mb-8">
            ...
            <Link href="/apps/pulse" className="hover:text-accent transition-colors">
              Pulse
            </Link>
            <span className="mx-2">&middot;</span>
          ...
          <h1 className="text-3xl md:text-4xl font-bold text-foreground mb-4">
            Request a Pulse instance
          </h1>
          <p className="text-foreground/70 mb-8">
            Tell us your name and email. We&apos;ll provision a dedicated Pulse
            instance on your own subdomain and send you access credentials.
          </p>
