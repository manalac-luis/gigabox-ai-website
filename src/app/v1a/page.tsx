...
export default function V1aDarkMode() {
  useEffect(() => {
  ...
  return (
    <main className="bg-[#0a0a0a]">
      ...
      <header className="fixed top-0 left-0 right-0 z-50 bg-[#0a0a0a]/80 backdrop-blur-sm border-b border-white/5">
        <nav className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="flex h-16 items-center justify-between">
            <Link href="/v1a" className="text-lg font-semibold tracking-tight text-white">
              GIGABOX
            </Link>
      ...
      <section className="relative min-h-screen flex items-center pt-16">
        ...
        <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-24">
          <div className="max-w-4xl">
            ...
            <p className="text-xl md:text-2xl text-[#a0a0a0] mb-10 max-w-2xl leading-relaxed">
      ...
      {/* Aura Section */}
      <section id="aura" className="py-24 bg-[#111111] scroll-mt-20">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid gap-8 md:grid-cols-3">
            {agents.map((agent) => (
              <div key={agent.name} className="bg-[#0a0a0a] p-8 rounded-xl border border-white/10">
                <div className="mb-4">
                  <span className="text-2xl font-semibold text-white">{agent.name}</span>
      ...
      {/* Platform Section */}
      <section id="platform" className="py-24 bg-[#0a0a0a] scroll-mt-20">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-white mb-4">
          ...
          <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-4 max-w-4xl mx-auto">
            {platformItems.map((item) => (
              <div key={item.title} className="bg-[#111111] p-6 rounded-xl border border-white/10 text-center">
          ...
          <p className="mt-12 text-center text-lg text-white/60">
            <span className="font-semibold text-white">Aura was built this way.</span>
          </p>
        </div>
      </section>
      ...
      <section className="py-24 bg-[#111111]">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
            {quotes.map((q) => (
              <div key={q.name} className="bg-[#0a0a0a] p-6 rounded-xl border border-white/10">
          ...
          <p className="mt-12 text-center text-xl text-white/60">
            We believe them.<br />
            <span className="text-white">We&apos;re building accordingly.</span>
          </p>
        </div>
      </section>

      {/* Research Section */}
      <section id="research" className="py-24 bg-[#0a0a0a] scroll-mt-20">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid gap-6 md:grid-cols-2">
            {papers.map((paper) => (
              <Link
                ...
                className="block bg-[#111111] p-6 rounded-xl border border-white/10 hover:border-white/20 transition-colors"
              >
      ...
      {/* Team Section */}
      <section id="team" className="py-24 bg-[#111111] scroll-mt-20">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <h2 className="text-center text-3xl md:text-4xl font-semibold tracking-tight text-white">
            Our Team
          </h2>
          <p className="mt-3 text-center text-white/60 text-lg">The humans who design.</p>
              ...
              <div key={m.name} className="flex h-full flex-col items-center text-center">
                <div className="relative mx-auto h-24 w-24 md:h-28 md:w-28">
                  <Image
                    ...
                    fill
                    sizes="112px"
                    className="rounded-full object-cover ring-1 ring-white/20 shadow-sm"
                  />
                </div>
                <div className="mt-4 font-semibold text-lg text-white">{m.name}</div>
                ...
                <Link
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="mt-auto pt-4 inline-flex items-center justify-center w-9 h-9 rounded bg-white text-[#0a0a0a] hover:bg-white/90 transition-colors"
      ...
      <section id="contact" className="py-24 bg-[#0a0a0a] scroll-mt-20">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="max-w-2xl mx-auto bg-[#111111] p-8 rounded-lg border border-white/10">
