...
export default function V1dFullBleed() {
  useEffect(() => {
    ...
    <main className="bg-[#fafafa]">
      ...
      <header className="fixed top-0 left-0 right-0 z-50 bg-transparent">
        <nav className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="flex h-16 items-center justify-between">
            <Link href="/v1d" className="text-lg font-semibold tracking-tight text-white drop-shadow-sm">
              GIGABOX
            </Link>
      ...
      <section className="relative min-h-screen flex items-center justify-center">
        ...
        <div className="relative z-10 text-center px-4 sm:px-6 lg:px-8 max-w-5xl mx-auto">
          <h1 className="text-5xl md:text-7xl lg:text-8xl font-bold tracking-tight text-white mb-6 leading-[1.1] drop-shadow-lg">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <a
              href="#aura"
              className="inline-flex items-center px-8 py-4 bg-white text-black font-semibold rounded-lg hover:bg-white/90 transition-colors"
            >
              Meet Aura
            </a>
            <a
      ...
      <section id="aura" className="py-24 bg-white scroll-mt-20">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid gap-8 md:grid-cols-3">
            {agents.map((agent) => (
              <div key={agent.name} className="bg-[#fafafa] p-8 rounded-xl border border-black/10">
                <div className="mb-4">
                  <span className="text-2xl font-semibold text-black">{agent.name}</span>
          ...
          <div className="mt-12 text-center">
            <a
              href="#"
              className="inline-flex items-center px-8 py-4 bg-black text-white font-semibold rounded-lg hover:bg-black/90 transition-colors"
            >
      ...
      {/* Platform Section */}
      <section id="platform" className="py-24 bg-[#fafafa] scroll-mt-20">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-black mb-4">
          ...
          <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-4 max-w-4xl mx-auto">
            {platformItems.map((item) => (
              <div key={item.title} className="bg-white p-6 rounded-xl border border-black/10 text-center shadow-sm">
          ...
          <p className="mt-12 text-center text-lg text-black/60">
            <span className="font-semibold text-black">Aura was built this way.</span>
          </p>
        </div>
      </section>
      ...
      <section className="py-24 bg-white">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
            {quotes.map((q) => (
              <div key={q.name} className="bg-[#fafafa] p-6 rounded-xl border border-black/10">
          ...
          <p className="mt-12 text-center text-xl text-black/60">
            We believe them.<br />
            <span className="text-black font-medium">We&apos;re building accordingly.</span>
          </p>
        </div>
      </section>

      {/* Research Section */}
      <section id="research" className="py-24 bg-[#fafafa] scroll-mt-20">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="flex items-end justify-between mb-12">
            ...
            <Link
              href="/research"
              className="hidden sm:inline-flex items-center text-black hover:text-black/70 font-medium"
            >
              View All Research
          ...
          <div className="grid gap-6 md:grid-cols-2">
            {papers.map((paper) => (
              <Link
                ...
                className="block bg-white p-6 rounded-xl border border-black/10 hover:shadow-md transition-shadow"
              >
          ...
          <Link
            href="/research"
            className="sm:hidden mt-8 inline-flex items-center text-black hover:text-black/70 font-medium"
          >
            View All Research
            <svg className="w-4 h-4 ml-1" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor">
              <path strokeLinecap="round" strokeLinejoin="round" d="M8.25 4.5l7.5 7.5-7.5 7.5" />
            ...
            {team.map((m) => (
              <div key={m.name} className="flex h-full flex-col items-center text-center">
                ...
                <Link
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="mt-auto pt-4 inline-flex items-center justify-center w-9 h-9 rounded bg-black text-white hover:bg-black/80 transition-colors"
      ...
      <section id="contact" className="py-24 bg-[#fafafa] scroll-mt-20">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-center mb-8">
            <a href="mailto:info@gigabox.ai" className="text-black hover:text-black/70 transition-colors underline">info@gigabox.ai</a>
          </p>
          <div className="max-w-2xl mx-auto bg-white p-8 rounded-lg border border-black/10 shadow-sm">
