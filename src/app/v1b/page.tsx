...
export default function V1bSplitLayout() {
  useEffect(() => {
    ...
    <main className="bg-[#fafafa]">
      ...
      <header className="fixed top-0 left-0 right-0 z-50 bg-white/80 backdrop-blur-sm border-b border-black/5">
        <nav className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="flex h-16 items-center justify-between">
            <Link href="/v1b" className="text-lg font-semibold tracking-tight text-black">
              GIGABOX
            </Link>
      ...
      <section className="min-h-screen pt-16 bg-white">
        <div className="flex flex-col lg:flex-row min-h-[calc(100vh-4rem)]">
          {/* Left side - Text */}
          <div className="flex-1 flex items-center px-4 sm:px-6 lg:px-12 xl:px-20 py-16 lg:py-0">
            <div className="max-w-xl">
              <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold tracking-tight text-black mb-6 leading-[1.1]">
              ...
              <div className="flex flex-wrap gap-4">
                <a
                  href="#aura"
                  className="inline-flex items-center px-8 py-4 bg-[#2563eb] text-white font-semibold rounded-lg hover:bg-[#1d4ed8] transition-colors"
                >
                  Meet Aura
                </a>
                <a
                  href="#research"
                  className="inline-flex items-center px-8 py-4 border-2 border-[#2563eb] text-[#2563eb] font-semibold rounded-lg hover:bg-[#2563eb]/5 transition-colors"
                >
                  Our Research
                </a>
              </div>
          ...
          {/* Right side - Image */}
          <div className="flex-1 lg:flex-[0.9] relative min-h-[400px] lg:min-h-0">
            <img
              src="/hero.jpg"
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-4 max-w-4xl mx-auto">
            {platformItems.map((item) => (
              <div key={item.title} className="bg-[#fafafa] p-6 rounded-xl border border-black/10 text-center">
      ...
      <section id="research" className="py-24 bg-white scroll-mt-20">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="flex items-end justify-between mb-12">
            ...
            <Link
              href="/research"
              className="hidden sm:inline-flex items-center text-[#2563eb] hover:text-[#1d4ed8] font-medium"
            >
              View All Research
          ...
          <div className="grid gap-6 md:grid-cols-2">
            {papers.map((paper) => (
              <Link
                ...
                className="block bg-[#fafafa] p-6 rounded-xl border border-black/10 hover:border-[#2563eb]/30 hover:shadow-sm transition-all"
              >
          ...
          <Link
            href="/research"
            className="sm:hidden mt-8 inline-flex items-center text-[#2563eb] hover:text-[#1d4ed8] font-medium"
          >
            View All Research
            <svg className="w-4 h-4 ml-1" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor">
              <path strokeLinecap="round" strokeLinejoin="round" d="M8.25 4.5l7.5 7.5-7.5 7.5" />
            ...
            {team.map((m) => (
              <div key={m.name} className="flex h-full flex-col items-center text-center">
                ...
                <Link
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="mt-auto pt-4 inline-flex items-center justify-center w-9 h-9 rounded bg-[#2563eb] text-white hover:bg-[#1d4ed8] transition-colors"
      ...
      <section id="contact" className="py-24 bg-white scroll-mt-20">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-center mb-8">
            <a href="mailto:info@gigabox.ai" className="text-[#2563eb] hover:text-[#1d4ed8] transition-colors">info@gigabox.ai</a>
          </p>
